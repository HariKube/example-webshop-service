...
// +kubebuilder:rbac:groups=product.webshop.harikube.info,resources=emails,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=product.webshop.harikube.info,resources=emails/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=product.webshop.harikube.info,resources=emails/finalizers,verbs=update
